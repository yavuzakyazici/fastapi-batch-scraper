...
from .schemas import User as UserSchema, RegisterUser, Token, TokenData
...
@user_login_router.get("/me/", response_model=UserSchema)
async def read_users_me(
    current_user: Annotated[UserSchema, Security(get_current_active_user)]
):
    return current_user
